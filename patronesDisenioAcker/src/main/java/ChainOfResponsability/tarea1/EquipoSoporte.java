...
public class EquipoSoporte implements IHandler{
    ...
    public void reporteProblema(Cliente cliente, String titulo, String severidad, String descripcion) {
        if (severidad.equals("baja")){
            System.out.println("EL equipo de soporte pudo arreglar el siguiente problema: "+titulo+", con severidad: "+severidad+" y con descripcion: "+descripcion);
            System.out.println("Se le resolvio el problema al cliente con los datos: ");
            cliente.showInfoCLiente();
        } else {
            System.out.println("El equipo de soporte no pudo arreglar el problema "+titulo+", con la severidad: "+severidad+" y con la descripcion: "+descripcion+". Se lo pasa a revision al siguiente nivel superior...");
