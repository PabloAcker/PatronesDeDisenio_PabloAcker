...
public class QA implements IHandler{
    ...
    public void reporteProblema(Cliente cliente, String titulo, String severidad, String descripcion) {
        if (severidad.equals("alta")){
            System.out.println("EL QA pudo arreglar el siguiente problema: "+titulo+", con severidad: "+severidad+" y con descripcion: "+descripcion);
            System.out.println("Se le resolvio el problema al cliente con los datos: ");
            cliente.showInfoCLiente();
        } else {
            System.out.println("El QA no pudo arreglar el problema "+titulo+", con la severidad: "+severidad+" y con la descripcion: "+descripcion+". Se lo pasa a revision al siguiente nivel superior...");
